...
export class ReportsModule {
   ...
   */
  async getGoodsLabelingReport(params?: Record<string, unknown>): Promise<unknown[]> {
   ...
   */
  async getCharacteristicsChangeReport(params?: Record<string, unknown>): Promise<unknown[]> {
    return this.client.get<unknown[]>(
   ...
   * @param params - Optional query parameters for filtering
   *
   * @returns Promise resolving to array of incorrect attachment records
   *
   * @throws {AuthenticationError} When API key is invalid
   * @throws {RateLimitError} When rate limit exceeded (1 req/min)
   * @throws {NetworkError} When network or server error occurs
   ...
   * @see {@link https://dev.wildberries.ru/openapi/reports#tag/Otchyoty-ob-uderzhaniyah}
   */
  async getIncorrectAttachmentsReport(params?: Record<string, unknown>): Promise<unknown[]> {
    return this.client.get<unknown[]>(
   ...
   * @param params - Optional query parameters for filtering
   *
   * @returns Promise resolving to warehouse measurements data
   *
   * @throws {AuthenticationError} When API key is invalid
   * @throws {RateLimitError} When rate limit exceeded (1 req/min)
   * @throws {NetworkError} When network or server error occurs
   ...
   */
  async requestAcceptanceReport(params?: Record<string, unknown>): Promise<ReportTaskResponse> {
    return this.client.get<ReportTaskResponse>(
  ...
  async getAcceptanceReportStatus(taskId: string): Promise<ReportStatus> {
    return this.checkReportStatus(taskId, 'acceptance');
  }
  ...
  async downloadAcceptanceReport(taskId: string): Promise<Blob> {
    return this.downloadReport(taskId, 'acceptance');
  }
   ...
   */
  async requestPaidStorageReport(params?: Record<string, unknown>): Promise<ReportTaskResponse> {
    return this.client.get<ReportTaskResponse>(
  ...
  async getPaidStorageReportStatus(taskId: string): Promise<ReportStatus> {
    return this.checkReportStatus(taskId, 'paid_storage');
  }
  ...
  async downloadPaidStorageReport(taskId: string): Promise<Blob> {
    return this.downloadReport(taskId, 'paid_storage');
  }
   ...
   */
  async getRegionalSalesReport(params?: Record<string, unknown>): Promise<unknown[]> {
    return this.client.get<unknown[]>(
   ...
   * @see {@link https://dev.wildberries.ru/openapi/reports#tag/Dolya-brenda-v-prodazhah}
   */
  async getBrandShareReport(params: Record<string, unknown>): Promise<unknown> {
    return this.client.get<unknown>(
   ...
   */
  async getBlockedProductsReport(params?: Record<string, unknown>): Promise<unknown[]> {
    return this.client.get<unknown[]>(
   ...
   * @see {@link https://dev.wildberries.ru/openapi/reports#tag/Skrytye-tovary}
   */
  async getShadowedProductsReport(params?: Record<string, unknown>): Promise<unknown[]> {
    return this.client.get<unknown[]>(
   ...
   */
  async getGoodsReturnReport(params?: Record<string, unknown>): Promise<unknown[]> {
    return this.client.get<unknown[]>(
