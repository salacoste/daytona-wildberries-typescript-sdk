...
describe('RetryHandler Integration Tests', () => {
  ...
  describe('Network timeout recovery', () => {
    // Skip: MSW's delay doesn't properly trigger axios timeouts in Node.js
    // The delay completes and returns a response rather than causing a timeout
    it.skip('should retry after timeout and succeed', async () => {
      let attempts = 0;
