...
describe('CommunicationsModule', () => {
  ...
  // ============================================================================
  // Deprecated Methods (6 methods) - Test deprecation warnings
  // ============================================================================

  describe('Deprecated Methods', () => {
    describe('supplierValuations() - Deprecated', () => {
      ...
      it('should only warn once per session', async () => {
        const warnSpy = vi.spyOn(console, 'warn').mockImplementation(vi.fn());
        mockClient.get.mockResolvedValue({ data: {} });
      ...
      it('should still call the API', async () => {
    ...
    describe('createFeedbacksAction() - Deprecated', () => {
      it('should emit deprecation warning', async () => {
        const warnSpy = vi.spyOn(console, 'warn').mockImplementation(vi.fn());
        mockClient.post.mockResolvedValue(undefined);
    ...
    describe('createTemplate() - Deprecated', () => {
      it('should emit deprecation warning', async () => {
        const warnSpy = vi.spyOn(console, 'warn').mockImplementation(vi.fn());
    ...
    describe('updateTemplate() - Deprecated', () => {
      it('should emit deprecation warning', async () => {
        const warnSpy = vi.spyOn(console, 'warn').mockImplementation(vi.fn());
    ...
    describe('deleteTemplate() - Deprecated', () => {
      it('should emit deprecation warning', async () => {
        const warnSpy = vi.spyOn(console, 'warn').mockImplementation(vi.fn());
