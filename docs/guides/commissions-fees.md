...
**Этот документ описывает тарифы на остаток.** Для тарифов на поставку см. [tariffs-overview.md](./tariffs-overview.md).
...
Пример для склада Краснодар:
- **На остаток**: логистика 73,6 руб, коэф. 160%
- **На поставку**: логистика 75,9 руб, коэф. 165%
...
- [Tariffs Overview](./tariffs-overview.md) - Обзор всех типов тарифов (на остаток и на поставку)
