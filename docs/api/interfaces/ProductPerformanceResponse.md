...
Defined in: [types/analytics.types.ts:476](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/34d2fe37f2bf1eed06c6ea8c3452f3ceb19d57ae/src/types/analytics.types.ts#L476)
...
| <a id="products"></a> `products` | [`ProductPerformanceMetrics`](ProductPerformanceMetrics.md)[] | Array of product performance metrics | - | [types/analytics.types.ts:478](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/34d2fe37f2bf1eed06c6ea8c3452f3ceb19d57ae/src/types/analytics.types.ts#L478) |
