[Wildberries API TypeScript SDK](../modules.md) / ProductPerformanceResponse

# Interface: ProductPerformanceResponse

Defined in: [types/analytics.types.ts:476](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/784d5eafeca072e72c3a26b140b006a3b641c991/src/types/analytics.types.ts#L476)
...
| <a id="products"></a> `products` | [`ProductPerformanceMetrics`](ProductPerformanceMetrics.md)[] | Array of product performance metrics | - | [types/analytics.types.ts:478](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/784d5eafeca072e72c3a26b140b006a3b641c991/src/types/analytics.types.ts#L478) |
