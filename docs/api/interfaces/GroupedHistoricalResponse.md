...
Defined in: [types/analytics.types.ts:309](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/34d2fe37f2bf1eed06c6ea8c3452f3ceb19d57ae/src/types/analytics.types.ts#L309)
...
| <a id="data"></a> `data` | [`GroupedHistory`](GroupedHistory.md)[] | Response data | - | [types/analytics.types.ts:311](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/34d2fe37f2bf1eed06c6ea8c3452f3ceb19d57ae/src/types/analytics.types.ts#L311) |
