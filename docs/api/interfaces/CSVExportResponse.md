...
Defined in: [types/analytics.types.ts:630](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/784d5eafeca072e72c3a26b140b006a3b641c991/src/types/analytics.types.ts#L630)
...
| <a id="reportid"></a> `reportId` | `string` | Generated report ID for status tracking and download | - | [types/analytics.types.ts:632](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/784d5eafeca072e72c3a26b140b006a3b641c991/src/types/analytics.types.ts#L632) |
| <a id="status"></a> `status` | [`ReportStatus`](../-internal-/type-aliases/ReportStatus.md) | Initial status (typically 'pending') | - | [types/analytics.types.ts:634](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/784d5eafeca072e72c3a26b140b006a3b641c991/src/types/analytics.types.ts#L634) |
| <a id="estimatedcompletiontime"></a> `estimatedCompletionTime?` | `string` | Estimated completion time (ISO timestamp) | - | [types/analytics.types.ts:636](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/784d5eafeca072e72c3a26b140b006a3b641c991/src/types/analytics.types.ts#L636) |
