...
Defined in: [errors/rate-limit-error.ts:25](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/65f92e97515b67789156305aa76517f94c34a324/src/errors/rate-limit-error.ts#L25)
...
Defined in: [errors/rate-limit-error.ts:41](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/65f92e97515b67789156305aa76517f94c34a324/src/errors/rate-limit-error.ts#L41)
...
| <a id="retryafter"></a> `retryAfter` | `readonly` | `number` | Milliseconds to wait before retrying the request | - | [errors/rate-limit-error.ts:29](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/65f92e97515b67789156305aa76517f94c34a324/src/errors/rate-limit-error.ts#L29) |
...
Defined in: [errors/rate-limit-error.ts:59](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/65f92e97515b67789156305aa76517f94c34a324/src/errors/rate-limit-error.ts#L59)
...
Defined in: [errors/rate-limit-error.ts:80](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/65f92e97515b67789156305aa76517f94c34a324/src/errors/rate-limit-error.ts#L80)
...
| ------ | ------ | ------ |
| `name` | `string` | [errors/rate-limit-error.ts:81](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/65f92e97515b67789156305aa76517f94c34a324/src/errors/rate-limit-error.ts#L81) |
| `message` | `string` | [errors/rate-limit-error.ts:82](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/65f92e97515b67789156305aa76517f94c34a324/src/errors/rate-limit-error.ts#L82) |
| `statusCode` | `number` | [errors/rate-limit-error.ts:83](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/65f92e97515b67789156305aa76517f94c34a324/src/errors/rate-limit-error.ts#L83) |
| `retryAfter` | `number` | [errors/rate-limit-error.ts:84](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/65f92e97515b67789156305aa76517f94c34a324/src/errors/rate-limit-error.ts#L84) |
| `response?` | `unknown` | [errors/rate-limit-error.ts:85](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/65f92e97515b67789156305aa76517f94c34a324/src/errors/rate-limit-error.ts#L85) |
| `requestId?` | `string` | [errors/rate-limit-error.ts:86](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/65f92e97515b67789156305aa76517f94c34a324/src/errors/rate-limit-error.ts#L86) |
