[Wildberries API TypeScript SDK](../../modules.md) / [\<internal\>](../modules.md) / ReportDownloadsResponse

# Interface: ReportDownloadsResponse

Defined in: [types/analytics.types.ts:699](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/784d5eafeca072e72c3a26b140b006a3b641c991/src/types/analytics.types.ts#L699)
...
| <a id="data"></a> `data` | [`ReportDownloadItem`](ReportDownloadItem.md)[] | Array of report download items | - | [types/analytics.types.ts:701](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/784d5eafeca072e72c3a26b140b006a3b641c991/src/types/analytics.types.ts#L701) |
