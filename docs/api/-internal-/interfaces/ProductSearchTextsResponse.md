...
Defined in: [types/analytics.types.ts:751](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/784d5eafeca072e72c3a26b140b006a3b641c991/src/types/analytics.types.ts#L751)
...
| <a id="data"></a> `data` | \{ `nmId`: `number`; `texts`: [`SearchTextItem`](SearchTextItem.md)[]; \} | - | - | [types/analytics.types.ts:752](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/784d5eafeca072e72c3a26b140b006a3b641c991/src/types/analytics.types.ts#L752) |
| `data.nmId` | `number` | Product article number | - | [types/analytics.types.ts:754](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/784d5eafeca072e72c3a26b140b006a3b641c991/src/types/analytics.types.ts#L754) |
| `data.texts` | [`SearchTextItem`](SearchTextItem.md)[] | Array of search texts | - | [types/analytics.types.ts:756](https://github.com/salacoste/daytona-wildberries-typescript-sdk/blob/784d5eafeca072e72c3a26b140b006a3b641c991/src/types/analytics.types.ts#L756) |
