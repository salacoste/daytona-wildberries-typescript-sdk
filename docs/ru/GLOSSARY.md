...
### Модули (Modules)
Группы конечных точек API, организованные по функциональности. SDK включает 14 модулей, соответствующих доменам API Wildberries.
...
### WildberriesSDK
Основной класс SDK, служащий точкой входа и агрегатором модулей. Предоставляет все 14 модулей API в виде свойств.
...
### Node.js
JavaScript runtime для серверной разработки. SDK требует Node.js 20.x или 22.x LTS (`engines.node`: ≥20.0.0).
