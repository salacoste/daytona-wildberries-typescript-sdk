...
::: tip Новое в v3.10.0
**[Модуль возвратов (`sdk.returns`)](/ru/guides/returns-module)** — Унифицированный агрегатор, объединяющий аналитику FBO, историю заказов FBS и финансовые отчёты в единый массив `ReturnItem[]`. Один вызов метода заменяет самостоятельное объединение трёх источников с разным расписанием обновлений. Включает `classifyReturnReason()`, прозрачность частичных сбоев и `getReturnStats()` для агрегации по SKU/категориям.
:::
...
### Финансовая сверка
- **[Модуль возвратов](/ru/guides/returns-module)** - Унифицированный агрегатор `sdk.returns`, объединяющий источники FBO, FBS и Finance в единый массив ReturnItem с полной прозрачностью о состоянии источников и ограничениях. **(Новое в v3.10.0)**
- **[Сверка выкупов и возвратов](/ru/guides/buyout-return-reconciliation)** - Классификация причин возвратов FBO/FBS, обогащение возвратов полем `orderType` и сверка с выкупами по nmId через три чистые вспомогательные функции. **(Новое в v3.9.3)**
