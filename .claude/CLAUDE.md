...
- **Version**: **4.5.0** (production-ready; Sept 2026 WB API sync landed — daily limits, budget v2 + v1 deprecation, supply discrepancies/drafts, SPOT, shipping + ETrN waybill, card documents, seller-warehouses stocks, DT typed error)
