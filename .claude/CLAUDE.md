...
- **Version**: **4.6.0** (production-ready; Sept 2026 WB API sync landed — daily limits, budget v2 + v1 deprecation, supply discrepancies/drafts, SPOT, shipping + ETrN waybill, card documents, seller-warehouses stocks, DT typed error, goods-return v1 + old report deprecation)
...
| 7 | `sdk.analytics` | `AnalyticsModule` | seller-analytics-api | 21 | Sales funnel v3, search queries, stock history, CSV reports, item rating v2, real-time order feed |
| 8 | `sdk.communications` | `CommunicationsModule` | common-api | 25 | Customer chat, product Q&A, reviews, pinned reviews |
| 9 | `sdk.reports` | `ReportsModule` | statistics-api | 26 | Incomes, stocks, sales/returns, excise, async warehouse-remains reports, goods-return v1 |
...
**Total: 306 public methods across the 14 modules.**
